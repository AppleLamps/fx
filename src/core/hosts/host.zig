...
pub fn nativeForOs(os_tag: std.Target.Os.Tag) Capabilities {
    return .{
        ...
        // Windows joined this in phase 3, when `url_opener` gained its
        // `rundll32 url.dll,FileProtocolHandler` arm. The flag lagged the
        // launcher by a phase; the launcher has since been run.
