...
const allowlist: AllowRule[] = [
  ...
  rule("src/pty_probe.zig", "(?:main|printSnapshot)", /debug_print/, "terminal_probe", "standalone ConPTY probe progress output"),
  rule("src/fx_drive.zig", "main", /debug_print/, "terminal_probe", "standalone interactive drive probe progress output"),
  ...
  rule("src/core/shared/stdio.zig", "(?:stdin|stdout|stderr|stdoutFile)", /^stdio_acquisition$/, "stdio_provider", "standard-stream handle accessors"),
